  ...
  <xsl:apply-templates select="cbc:Description"/>
	...
	<xsl:template match="cac:AdditionalDocumentReference" mode="DespatchAdvice">
		...
		<xsl:if test="cac:Attachment">
			...
			<b>
				...
				<xsl:apply-templates select="cac:Attachment/cbc:EmbeddedDocumentBinaryObject"/>&#160;[<xsl:apply-templates select="cac:Attachment/cbc:EmbeddedDocumentBinaryObject/@mimeCode"/>]
	...
	<xsl:template match="cac:Shipment" mode="DespatchAdviceHeader">
		...
		<xsl:call-template name="LabelName">
		  ...
		  <xsl:apply-templates select="cbc:GrossWeightMeasure"/>&#160;[<xsl:apply-templates select="cbc:GrossWeightMeasure/@unitCode"/>]
          <br/>	
		</xsl:if>
		...
		<xsl:call-template name="LabelName">
		  ...
		  <xsl:apply-templates select="cbc:GrossVolumeMeasure"/>&#160;[<xsl:apply-templates select="cbc:GrossVolumeMeasure/@unitCode"/>]
          <br/>	
		</xsl:if>
		...
		<xsl:if test="cac:Consignment">
			...
			<xsl:if test="cac:Consignment/cac:CarrierParty">
				...
				<xsl:apply-templates select="cac:Consignment/cac:CarrierParty/cac:PartyIdentification/cbc:ID"/>&#160;[<xsl:apply-templates select="cac:Consignment/cac:CarrierParty/cac:PartyIdentification/cbc:ID/@schemeID"/>]
				<br/>
			</xsl:if>
	...
	<xsl:template match="cac:DespatchLine" mode="despatch">
		<tr>
			...
			<b>
				...
				<xsl:apply-templates select="cac:Item/cac:StandardItemIdentification/cbc:ID"/>(<xsl:apply-templates select="cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID"/>)
				<br/>
			...
			<b>
						...
						<br/>
				<xsl:apply-templates select="cbc:DeliveredQuantity"/>(<xsl:apply-templates select="cbc:DeliveredQuantity/@unitCode"/>)
				...
				<b>
						...
						<br/>
				<xsl:apply-templates select="cbc:OutstandingQuantity"/>(<xsl:apply-templates select="cbc:OutstandingQuantity/@unitCode"/>)
				<br/>
			</xsl:if>
...
<b>
			  ...
			  <xsl:apply-templates select="cbc:ItemClassificationCode"/>(<xsl:apply-templates select="cbc:ItemClassificationCode/@listID"/>)
	...
	<xsl:template match="cac:Shipment/cac:TransportHandlingUnit" mode="DespatchLineShipment">
		...
		<b>
			...
			= <xsl:apply-templates select="cbc:Measure"/>(<xsl:apply-templates select="cbc:Measure/@unitCode"/>)
		</xsl:if>
